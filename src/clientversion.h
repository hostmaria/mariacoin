...
#error Client version information missing: version is not defined by maria-config.h or in any other way
#endif
...
/**
 * mariad-res.rc includes this file, but it cannot cope with real c++ code.
