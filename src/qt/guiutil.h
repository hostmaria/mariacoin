...
/** Utility functions used by the MARIA Qt UI.
 */
namespace GUIUtil
{
...
// Render MARIA addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZmari = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZmari = false);
...
// Parse "maria:" URI into recipient object, return true on successful parsing
