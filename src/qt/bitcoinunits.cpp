...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(mMARI);
    unitlist.append(uMARI);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case MARI:
        return QString("maria");
    case mMARI:
        return QString("mmaria");
    case uMARI:
        return QString::fromUtf8("umaria");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZmari)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZMARI)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZMARI);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZMARI)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZMARI));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
