...
#include "qt/maria/createproposaldialog.h"
#include "qt/maria/forms/ui_createproposaldialog.h"

#include "qt/maria/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(MARIAGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.maria/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 MARI");
