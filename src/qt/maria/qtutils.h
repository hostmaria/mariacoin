...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, MARIAGUI* gui, double posX = 3, int posY = 5, bool hideOpaqueBackground = true);
bool openDialogWithOpaqueBackground(QDialog* widget, MARIAGUI* gui, double posX = 3);
