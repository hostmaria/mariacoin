...
#include "qt/maria/forms/ui_masternodeswidget.h"

#include "qt/maria/qtutils.h"
#include "qt/maria/mnrow.h"
#include "qt/maria/mninfodialog.h"
#include "qt/maria/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(MARIAGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= mnCollateralAmount) {
        inform(tr("Not enough balance to create a masternode, %1 required.")
            .arg(GUIUtil::formatBalance(mnCollateralAmount, BitcoinUnits::MARI)));
        return;
    }
    showHideOp(true);
