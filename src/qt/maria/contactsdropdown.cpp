...
#include "qt/maria/contactdropdownrow.h"
...
ContactsDropdown::ContactsDropdown(int minWidth, int minHeight, MARIAGUI* _window, QWidget* _parent) : PWidget(_window, _parent)
{
