...
#include "qt/maria/topbar.h"
#include "qt/maria/forms/ui_topbar.h"
#include "qt/maria/lockunlock.h"
#include "qt/maria/qtutils.h"
#include "qt/maria/receivedialog.h"
#include "qt/maria/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/maria/balancebubble.h"
...
TopBar::TopBar(MARIAGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopMari, ui->labelAmountTopShieldedMari}, "amount-small-topbar");
    setCssProperty({ui->labelAmountMari}, "amount-topbar");
    setCssProperty({ui->labelPendingMari, ui->labelImmatureMari}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("MARIA")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // MARI Total
    QString totalMari = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // MARI
    // Top
    ui->labelAmountTopMari->setText(totalTransparent);
    ui->labelAmountTopShieldedMari->setText(totalShielded);
    // Expanded
    ui->labelAmountMari->setText(totalMari);
    ui->labelPendingMari->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureMari->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
