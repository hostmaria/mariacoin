...
#include "qt/maria/sendcustomfeedialog.h"
#include "qt/maria/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(MARIAGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &MARIAGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
