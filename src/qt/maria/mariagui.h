...
#ifndef MARIA_CORE_NEW_GUI_MARIAGUI_H
#define MARIA_CORE_NEW_GUI_MARIAGUI_H
...
#include "qt/maria/navmenuwidget.h"
#include "qt/maria/topbar.h"
#include "qt/maria/dashboardwidget.h"
#include "qt/maria/send.h"
#include "qt/maria/receivewidget.h"
#include "qt/maria/addresseswidget.h"
#include "qt/maria/coldstakingwidget.h"
#include "qt/maria/governancewidget.h"
#include "qt/maria/masternodeswidget.h"
#include "qt/maria/snackbar.h"
#include "qt/maria/settings/settingswidget.h"
...
/**
  MARIA GUI main class. This class represents the main window of the MARIA UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MARIAGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MARIAGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~MARIAGUI();
...
#endif //MARIA_CORE_NEW_GUI_MARIAGUI_H
