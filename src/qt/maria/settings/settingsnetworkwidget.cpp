...
#include "qt/maria/settings/settingsnetworkwidget.h"
#include "qt/maria/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/maria/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(MARIAGUI* _window, QWidget *parent) :
