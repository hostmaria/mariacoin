...
#include "qt/maria/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/maria/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(MARIAGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to MARIAGUI::handleRestart()
