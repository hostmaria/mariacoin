...
#include "qt/maria/settings/settingsbackupwallet.h"
#include "qt/maria/settings/settingsexportcsv.h"
#include "qt/maria/settings/settingsbittoolwidget.h"
#include "qt/maria/settings/settingssignmessagewidgets.h"
#include "qt/maria/settings/settingswalletrepairwidget.h"
#include "qt/maria/settings/settingswalletoptionswidget.h"
#include "qt/maria/settings/settingsmainoptionswidget.h"
#include "qt/maria/settings/settingsdisplayoptionswidget.h"
#include "qt/maria/settings/settingsinformationwidget.h"
#include "qt/maria/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(MARIAGUI* parent);
    ~SettingsWidget();
