...
#include "qt/maria/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/maria/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(MARIAGUI* _window, QWidget *parent) :
