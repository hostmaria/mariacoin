...
#ifndef MARIA_WALLET_H
#define MARIA_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_MARIA = 61000, // inherited version..
...
public:
     ...
     * MARIA: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 MARI output and keys which can be used for the Masternode
