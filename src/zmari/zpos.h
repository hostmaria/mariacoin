...
class CLegacyZMariStake : public CStakeInput
{
private:
...
public:
    CLegacyZMariStake(const CBlockIndex* _pindexFrom, uint32_t _nChecksum, libzerocoin::CoinDenomination _denom, const uint256& _hashSerial) :
    ...
    static CLegacyZMariStake* NewZMariStake(const CTxIn& txin, int nHeight);
