Contributing to MARIA Core
============================

The MARIA Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Mariacoin/maria/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MARIA Core project, and is not to be
confused with overall MARIA Network Protocol consensus changes.

Whether a pull request is merged into MARIA Core rests with the project merge
...
Patches that change MARIA consensus rules are considerably more involved than
...
Where a patchset proposes to change the MARIA consensus, it must have been
...
The project leader is the release manager for each MARIA Core release.
