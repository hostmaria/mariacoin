...
To build MARIA Core using AFL instrumentation (this assumes that the
...
with certain assembly code from MARIA Core's code. See [developer notes on sanitizers](https://github.com/Mariacoin/MARIA/blob/master/doc/developer-notes.md#sanitizers)
