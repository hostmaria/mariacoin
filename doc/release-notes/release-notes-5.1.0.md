MARIA Core version v5.1.0 is now available from:  <https://github.com/Mariacoin/maria/releases>
...
- #2170 Better maria.conf Masternode data error notification (furszy)
