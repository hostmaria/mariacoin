...
The build script we'll be using is contained in the MARIA github repository ([contrib/gitian-build.py](https://github.com/Mariacoin/maria/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the MARIA repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Mariacoin/MARIA/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, maria-detached-sigs, and maria GitHub repos.
