...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "qt/maria/addresseswidget -> qt/maria/mariagui -> qt/maria/addresseswidget"
    "qt/maria/navmenuwidget -> qt/maria/mariagui -> qt/maria/navmenuwidget"
    "qt/maria/mariagui -> qt/maria/qtutils -> qt/maria/mariagui"
    "qt/maria/qtutils -> qt/maria/snackbar -> qt/maria/qtutils"
    "sapling/saplingscriptpubkeyman -> wallet/wallet -> sapling/saplingscriptpubkeyman"
    "spork -> sporkdb -> spork"
    "spork -> validation -> spork"
    "txmempool -> validation -> txmempool"
    "validation -> validationinterface -> validation"
    "validation -> zmari/zmarimodule -> validation"
    "wallet/fees -> wallet/wallet -> wallet/fees"
    "wallet/scriptpubkeyman -> wallet/wallet -> wallet/scriptpubkeyman"
    "wallet/wallet -> wallet/walletdb -> wallet/wallet"
    "wallet/wallet -> zmarichain -> wallet/wallet"
    "zmari/zmarimodule -> zmarichain -> zmari/zmarimodule"
    ...
    "qt/askpassphrasedialog -> qt/maria/mariagui -> qt/maria/topbar -> qt/askpassphrasedialog"
    "qt/maria/coldstakingwidget -> qt/maria/tooltipmenu -> qt/maria/mariagui -> qt/maria/coldstakingwidget"
    "qt/maria/masternodeswidget -> qt/maria/tooltipmenu -> qt/maria/mariagui -> qt/maria/masternodeswidget"
    "qt/maria/mariagui -> qt/maria/send -> qt/maria/tooltipmenu -> qt/maria/mariagui"
    ...
    "chain -> legacy/stakemodifier -> validation -> zmarichain -> chain"
