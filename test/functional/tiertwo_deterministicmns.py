...
class DIP3Test(MariaTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 MARI) to the operator, and (2 * 2.7 MARI) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid MARIA address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid MARIA address InvalidPayee", controller.protx_update_registrar,
