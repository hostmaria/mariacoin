#!/usr/bin/env python3
# Copyright (c) 2020 The MARIA Core developers
...
class SaplingMempoolTest(MariaTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 MARI note to Alice
        ...
        # miner sends another 10 MARI note to Alice
