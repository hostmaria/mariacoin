...
class FullBlockTest(MariaTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure mariad isn't accepting b26
        ...
        # Extend the b28 chain to make sure mariad isn't accepting b28
        ...
        # MARIA: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the maria code has custom code which does so);
