...
COIN = 100000000 # 1 MARI in satoshis
...
# Objects that map to mariad objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in mariad indicates these should be deserialized as blocks
