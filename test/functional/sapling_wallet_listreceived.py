...
class ListReceivedTest (MariaTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 MARI.
        ...
        # Send 1 MARI to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 MARI sending them all (fee is 0.1 MARI)
        ...
        # Confirm transaction (2 MARI from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 MARI, send 0.6 MARI + 0.05 MARI fee
